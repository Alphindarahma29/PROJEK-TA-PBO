...
public class Transaksi extends javax.swing.JFrame {
    ...
    public Transaksi() {
        ...
        for (int i = 0; i < AllObject.produkArr.size(); i++) {
            ...
            txtidProduk.setText(AllObject.produkArr.get(i).getId());
            txtHargaProduk.setText(AllObject.produkArr.get(i).getHarga());
        }
        
        for (int a = 0; a < AllObject.treatArr.size(); a++) {
            CBTreat.addItem(AllObject.treatArr.get(a).getJenis());
            txtIdTreat.setText(AllObject.treatArr.get(a).getId());
            txtHargaTreat.setText(AllObject.treatArr.get(a).getHarga());
        }
...
//        }
    ...
    private void btnProdukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProdukActionPerformed
        double hp = Double.parseDouble(txtHargaProduk.getText()) * Double.parseDouble(txtJumlahProduk.getText());
        double th = Double.parseDouble(txtHargaProduk.getText());
        double ts = hp - (0.2 * hp);
    ...
    private void TotalBayarKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TotalBayarKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            txtKembalian.setText(String.valueOf(tt));
        }
